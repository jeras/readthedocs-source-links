...
# -- Custom extension for GitHub links ------------------------------------
...
latex_documents = [
    (master_doc, 'Test.tex', title, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'Test', title, author, 1)
]
...
texinfo_documents = [
    (master_doc, 'Test', title, author, 'Test',
